...
public class StarAnimation extends Animation
{
    ...
    static {
        StarAnimation.pitch = new float[] { 0.5f, 0.529732f, 0.561231f, 0.594604f, 0.629961f, 0.66742f, 0.707107f, 0.749154f, 0.793701f, 0.840896f, 0.890899f, 0.943874f, 1.0f, 1.059463f, 1.122462f, 1.189207f, 1.259921f, 1.33484f, 1.414214f, 1.498307f, 1.587401f, 1.681793f, 1.781797f, 1.887749f, 2.0f };
    }
    
    public StarAnimation(final PlayerManager playerManager, final MysteryVault mysteryVault, final Quality quality, final long n) {
        super(playerManager, mysteryVault, AnimationType.STAR, quality, n);
        this.volume = 0.05f;
    ...
    private void spawnMysteryBoxQualityBlock(final Player player, final int n, final Location location) {
        Bukkit.getScheduler().runTaskLater((Plugin)CookieGadgets.getInstance(), (Runnable)new Runnable() {
            ...
            public void run() {
                location.clone();
                final Location location = new Location(location.getWorld(), location.getX() + 0.5, location.getY() - 1.75, location.getZ() + 0.5, GMiniBlock.getYawByBlockFace(StarAnimation.this.blockFace), 0.0f);
                ...
                e.setHelmet(StarAnimation.this.getAnimation().getQualityBlock().getItemStack());
                ...
                StarAnimation.this.starArmorStand.add(e);
                new BukkitRunnable() {
    ...
    private void playSound(final SoundEffect soundEffect, final int n, final long n2) {
        new BukkitRunnable() {
            public void run() {
                soundEffect.playSound(StarAnimation.this.getMysteryVault().getLocation().clone(), 1.0f, StarAnimation.pitch[n]);
            }
