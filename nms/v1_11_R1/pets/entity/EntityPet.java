...
import ws.billy.CookieGadgets.nms.v1_11_R1.pets.CraftNMSCreature;
...
import net.minecraft.server.v1_11_R1.IAnimal;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_11_R1.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_11_R1.Entity> iterator = this.passengers.iterator();
    ...
    public void g(float n, float bf) {
        ...
        if (this.pet == null || this.bx().isEmpty() || !this.isOwnerRiding()) {
            this.P = 0.5f;
            this.aR = 0.02f;
            super.g(n, bf);
            return;
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_11_R1.Entity)this));
                if (bf > 0.0f) {
        ...
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_11_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_11_R1.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_11_R1.Entity entity) {
    ...
    public boolean c(final int n, final net.minecraft.server.v1_11_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_11_R1.ItemStack itemStack) {
    }
