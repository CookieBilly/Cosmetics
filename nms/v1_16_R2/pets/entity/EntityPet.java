...
import ws.billy.CookieGadgets.nms.v1_16_R2.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityInsentient implements IEntityPet, NMSPet
{
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_16_R2.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_16_R2.Entity> iterator = this.passengers.iterator();
    ...
    public void g(final Vec3D vec3D) {
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_16_R2.Entity)this));
                if (y > 0.0) {
                    this.setMot(this.getMot().add(-0.4 * MathHelper.sin(this.yaw * 0.017453292f) * 0.0, 0.0, 0.4 * MathHelper.cos(this.yaw * 0.017453292f) * 0.0));
                }
            }
            this.aB = this.aC;
        ...
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_16_R2.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_16_R2.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_16_R2.Entity entity) {
    ...
    public boolean a_(final int n, final net.minecraft.server.v1_16_R2.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_16_R2.ItemStack itemStack) {
    }
