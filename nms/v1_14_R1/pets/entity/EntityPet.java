...
import ws.billy.CookieGadgets.nms.v1_14_R1.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityInsentient implements IEntityPet, NMSPet
{
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_14_R1.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_14_R1.Entity> iterator = this.passengers.iterator();
    ...
    public void e(final Vec3D vec3D) {
        ...
        this.aK = yaw;
        this.K = 1.0f;
        double n = handle.bb * 0.5f;
        final double y = vec3D.y;
        final double n2 = handle.bd;
        double n3;
        if (n2 <= 0.0) {
        ...
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_14_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_14_R1.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_14_R1.Entity entity) {
    ...
    public boolean a_(final int n, final net.minecraft.server.v1_14_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_14_R1.ItemStack itemStack) {
    }
