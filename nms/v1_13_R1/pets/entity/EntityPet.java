...
package ws.billy.CookieGadgets.nms.v1_13_R1.pets.entity;

import net.minecraft.server.v1_13_R1.NBTTagCompound;
import net.minecraft.server.v1_13_R1.DamageSource;
import ws.billy.CookieGadgets.nms.v1_13_R1.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public EntityPet(final EntityTypes<?> entityTypes, final World world) {
        super((EntityTypes)entityTypes, world);
        this.FIELD_JUMP = null;
    }
    
    public EntityPet(final EntityTypes<?> entityTypes, final World world, final IPet pet) {
        super((EntityTypes)entityTypes, world);
        this.FIELD_JUMP = null;
        this.pet = pet;
        this.collides = false;
        ...
        if (this.FIELD_JUMP == null) {
            try {
                (this.FIELD_JUMP = EntityLiving.class.getDeclaredField("bg")).setAccessible(true);
            }
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_13_R1.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_13_R1.Entity> iterator = this.passengers.iterator();
    ...
    public void a(float n, float bi, float bj) {
        if (this.pet == null) {
            return;
        }
        if (this.pet.getOwner() == null) {
        ...
        bj = handle.bj;
        if (bj <= 0.0f) {
            bj *= (float)(this.rideSpeed * 0.25);
        }
        else {
            bj *= (float)this.rideSpeed;
        }
        if (!(this instanceof IEntityHorsePet)) {
            n *= 0.75f;
        }
        this.o((float)this.rideSpeed);
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_13_R1.Entity)this));
                if (bj > 0.0f) {
                ...
                this.aF = this.aG;
                final double n2 = this.locX - this.lastX;
                final double n3 = this.locZ - this.lastZ;
                float n4 = (float)(MathHelper.sqrt(n2 * n2 + n3 * n3) * 4.0);
                if (n4 > 1.0) {
                    n4 = 1.0f;
                }
                this.aJ += (n4 - this.aJ) * 0.4f;
                this.aK += this.aJ;
            }
        }
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_13_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_13_R1.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_13_R1.Entity entity) {
    ...
    public boolean c(final int n, final net.minecraft.server.v1_13_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_13_R1.ItemStack itemStack) {
    }
