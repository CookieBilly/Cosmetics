...
import ws.billy.CookieGadgets.nms.v1_13_R1.pets.entity.EntityTameablePet;
...
public class EntityWolfPet extends EntityTameablePet implements IEntityWolfPet
{
    ...
    public EntityWolfPet(final World world) {
        super((EntityTypes<?>)EntityTypes.WOLF, world);
    }
    
    public EntityWolfPet(final World world, final IPet pet) {
        super((EntityTypes<?>)EntityTypes.WOLF, world, pet);
    }
        ...
        if (this.inWater) {
            ...
            if (this.shakeCount > 0.4f) {
                ...
                for (int n2 = (int)(MathHelper.sin((this.shakeCount - 0.4f) * 3.1415927f) * 7.0f), i = 0; i < n2; ++i) {
                    this.world.addParticle((ParticleParam)Particles.R, this.locX + (this.random.nextFloat() * 2.0f - 1.0f) * this.width * 0.5f, (double)(n + 0.8f), this.locZ + (this.random.nextFloat() * 2.0f - 1.0f) * this.width * 0.5f, this.motX, this.motY, this.motZ);
                }
            }
        }
    }
