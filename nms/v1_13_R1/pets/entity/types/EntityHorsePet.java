...
import net.minecraft.server.v1_13_R1.EnumHorseArmor;
...
import ws.billy.CookieGadgets.nms.v1_13_R1.pets.entity.sub.EntityHorseAbstractPet;
...
public class EntityHorsePet extends EntityHorseAbstractPet implements IEntityHorsePet
{
    ...
    public EntityHorsePet(final World world) {
        super((EntityTypes<?>)EntityTypes.HORSE, world);
    }
    
    public EntityHorsePet(final World world, final IPet pet) {
        super((EntityTypes<?>)EntityTypes.HORSE, world, pet);
    }
