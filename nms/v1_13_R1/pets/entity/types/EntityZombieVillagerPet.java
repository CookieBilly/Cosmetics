...
public class EntityZombieVillagerPet extends EntityAgeablePet implements IEntityZombieVillagerPet
{
    ...
    static {
        ...
        ARMS_RAISED = DataWatcher.a((Class)EntityZombieVillagerPet.class, DataWatcherRegistry.i);
        CONVERTING = DataWatcher.a((Class)EntityZombieVillagerPet.class, DataWatcherRegistry.i);
    ...
    public EntityZombieVillagerPet(final World world) {
        super((EntityTypes<?>)EntityTypes.ZOMBIE_VILLAGER, world);
    }
    
    public EntityZombieVillagerPet(final World world, final IPet pet) {
        super((EntityTypes<?>)EntityTypes.ZOMBIE_VILLAGER, world, pet);
    }
