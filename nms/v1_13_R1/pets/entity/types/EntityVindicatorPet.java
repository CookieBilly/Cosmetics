...
import ws.billy.CookieGadgets.nms.v1_13_R1.pets.entity.sub.EntityIllagerAbstractPet;
...
public class EntityVindicatorPet extends EntityIllagerAbstractPet implements IEntityVindicatorPet
{
    ...
    public EntityVindicatorPet(final World world) {
        super((EntityTypes<?>)EntityTypes.VINDICATOR, world);
        this.johnny = false;
    }
    
    public EntityVindicatorPet(final World world, final IPet pet) {
        super((EntityTypes<?>)EntityTypes.VINDICATOR, world, pet);
        this.johnny = false;
    }
