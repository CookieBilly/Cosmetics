...
public abstract class EntityAgeablePet extends EntityPet implements IAgeablePet
{
    ...
    static {
        BABY = DataWatcher.a((Class)EntityAgeablePet.class, DataWatcherRegistry.i);
    }
    
    public EntityAgeablePet(final EntityTypes<?> entityTypes, final World world) {
        super(entityTypes, world);
        this.ageLocked = true;
    }
    
    public EntityAgeablePet(final EntityTypes<?> entityTypes, final World world, final IPet pet) {
