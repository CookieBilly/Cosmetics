...
public class EntityTameablePet extends EntityAgeablePet implements ITameable
{
    ...
    public EntityTameablePet(final EntityTypes<?> entityTypes, final World world) {
        super(entityTypes, world);
    }
    
    public EntityTameablePet(final EntityTypes<?> entityTypes, final World world, final IPet pet) {
