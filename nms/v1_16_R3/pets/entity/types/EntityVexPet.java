...
import ws.billy.CookieGadgets.nms.v1_16_R3.pets.entity.EntityNoClipPet;
...
public class EntityVexPet extends EntityNoClipPet implements IEntityVexPet
{
    ...
    static {
        DATA = DataWatcher.a((Class)EntityVexPet.class, (DataWatcherSerializer)DataWatcherWrapper.BYTE);
    }
    
    public EntityVexPet(final World world) {
        super((EntityTypes<? extends EntityInsentient>)EntityTypes.VEX, world);
    }
    
    public EntityVexPet(final World world, final IPet pet) {
        super((EntityTypes<? extends EntityInsentient>)EntityTypes.VEX, world, pet);
    }
