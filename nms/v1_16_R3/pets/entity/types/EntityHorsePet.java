...
import ws.billy.CookieGadgets.nms.v1_16_R3.pets.entity.sub.EntityHorseAbstractPet;
...
public class EntityHorsePet extends EntityHorseAbstractPet implements IEntityHorsePet
{
    ...
    static {
        MAKRING = DataWatcher.a((Class)EntityHorsePet.class, (DataWatcherSerializer)DataWatcherWrapper.INTEGER);
    }
