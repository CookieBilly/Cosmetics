...
public class EntityEndermanPet extends EntityPet implements IEntityEndermanPet
{
    ...
    static {
        BLOCK = DataWatcher.a((Class)EntityEndermanPet.class, (DataWatcherSerializer)DataWatcherWrapper.BLOCK_DATA);
        SCREAMING = DataWatcher.a((Class)EntityEndermanPet.class, (DataWatcherSerializer)DataWatcherWrapper.BOOLEAN);
    }
