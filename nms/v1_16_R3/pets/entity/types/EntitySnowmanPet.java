...
public class EntitySnowmanPet extends EntityPet implements IEntitySnowmanPet
{
    ...
    static {
        PUMPKIN = DataWatcher.a((Class)EntitySnowmanPet.class, (DataWatcherSerializer)DataWatcherWrapper.BYTE);
    }
    
    public EntitySnowmanPet(final World world) {
        super((EntityTypes<? extends EntityInsentient>)EntityTypes.SNOW_GOLEM, world);
    }
    
    public EntitySnowmanPet(final World world, final IPet pet) {
        super((EntityTypes<? extends EntityInsentient>)EntityTypes.SNOW_GOLEM, world, pet);
    }
