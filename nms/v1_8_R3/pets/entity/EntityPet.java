...
package ws.billy.CookieGadgets.nms.v1_8_R3.pets.entity;

import net.minecraft.server.v1_8_R3.NBTTagCompound;
import net.minecraft.server.v1_8_R3.DamageSource;
import ws.billy.CookieGadgets.nms.v1_8_R3.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public void removePassengerNMS() {
        ...
        ((CraftEntity)this.pet.getOwner()).getHandle().mount((net.minecraft.server.v1_8_R3.Entity)null);
    }
    ...
    public void g(float n, float ba) {
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_8_R3.Entity)this));
                if (ba > 0.0f) {
        ...
        if (this.JUMP_FIELD != null) {
            if (!this.isOnGround((net.minecraft.server.v1_8_R3.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_8_R3.Entity)this)) {
                try {
                    if (this.JUMP_FIELD.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_8_R3.Entity entity) {
    ...
    public boolean d(final int n, final net.minecraft.server.v1_8_R3.ItemStack itemStack) {
        return false;
    }
    
    public void setEquipment(final int n, final net.minecraft.server.v1_8_R3.ItemStack itemStack) {
    }
