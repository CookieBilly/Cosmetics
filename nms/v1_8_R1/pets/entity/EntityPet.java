...
package ws.billy.CookieGadgets.nms.v1_8_R1.pets.entity;

import net.minecraft.server.v1_8_R1.NBTTagCompound;
import net.minecraft.server.v1_8_R1.DamageSource;
import ws.billy.CookieGadgets.nms.v1_8_R1.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public EntityPet(final World world, final IPet pet) {
        ...
        if (this.JUMP_FIELD == null) {
            try {
                (this.JUMP_FIELD = EntityLiving.class.getDeclaredField("aW")).setAccessible(true);
            }
    ...
    public void resetEntitySize() {
        ...
        if (entitySize != null) {
            this.a(entitySize.width(), entitySize.height());
        }
    }
    ...
    public void resetEntitySize(final boolean b) {
        final EntitySize entitySize = this.getClass().getAnnotation(EntitySize.class);
        if (entitySize != null) {
            this.a(b ? (entitySize.width() / 2.0f) : entitySize.width(), b ? (entitySize.height() / 2.0f) : entitySize.height());
        }
    }
    ...
    public void removePassengerNMS() {
        ...
        ((CraftEntity)this.pet.getOwner()).getHandle().mount((net.minecraft.server.v1_8_R1.Entity)null);
    }
    ...
    public void g(float n, float ay) {
        ...
        ay = handle.aY;
        if (ay <= 0.0f) {
            ay *= (float)(0.25 * this.rideSpeed);
        }
        else {
            ay *= (float)this.rideSpeed;
        }
        if (!(this instanceof IEntityHorsePet)) {
            n *= 0.75f;
        }
        this.j((float)this.rideSpeed);
        if (!this.world.isStatic) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_8_R1.Entity)this));
                if (ay > 0.0f) {
        ...
        if (this.JUMP_FIELD != null) {
            if (!this.isOnGround((net.minecraft.server.v1_8_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_8_R1.Entity)this)) {
                try {
                    if (this.JUMP_FIELD.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_8_R1.Entity entity) {
    ...
    public boolean d(final int n, final net.minecraft.server.v1_8_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setEquipment(final int n, final net.minecraft.server.v1_8_R1.ItemStack itemStack) {
    }
