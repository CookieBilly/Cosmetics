...
import ws.billy.CookieGadgets.nms.v1_8_R2.armorstand.NMSMiniature;
...
import ws.billy.CookieGadgets.nms.v1_8_R2.armorstand.ArmorStandFollower;
...
import ws.billy.CookieGadgets.nms.v1_8_R2.armorstand.EntityNMSArmorStand;
...
import ws.billy.CookieGadgets.nms.v1_8_R2.pathfinders.PathFinderGoalPanic;
import net.minecraft.server.v1_8_R2.EntityCreature;
import org.bukkit.craftbukkit.v1_8_R2.entity.CraftEntity;
import net.minecraft.server.v1_8_R2.EntityInsentient;
import ws.billy.CookieGadgets.nms.v1_8_R2.pets.entity.SpawnUtil;
import ws.billy.CookieGadgets.nms.v1_8_R2.pets.registry.PetRegistry;
import ws.billy.CookieGadgets.nms.v1_8_R2.pets.pathfinders.Pathfinders;
...
public class NMSManagerImpl implements NMSManager
{
    ...
    public NMSArmorStand spawnNMSArmorStand(final World world, final double n, final double n2, final double n3, final String s) {
        ...
        final EntityNMSArmorStand nmsNameable = new EntityNMSArmorStand((net.minecraft.server.v1_8_R2.World)handle, craftHologram);
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_8_R2.Entity)nmsNameable)) {
    ...
    public NMSArmorStand spawnNMSArmorStandFollower(final World world, final double n, final double n2, final double n3, final Player player, final double additionY, final String s, final ArmorStandSlot armorStandSlot, final ItemStack itemStack) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final ArmorStandFollower armorStandFollower = new ArmorStandFollower((net.minecraft.server.v1_8_R2.World)handle, player);
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_8_R2.Entity)armorStandFollower)) {
    ...
    public NMSEntityMiniature spawnNMSMiniature(final World world, final double n, final double n2, final double n3, final boolean b, final Player player, final String s, final MiniatureEquipments miniatureEquipments) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final NMSMiniature nmsMiniature = new NMSMiniature((net.minecraft.server.v1_8_R2.World)handle, player, b);
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_8_R2.Entity)nmsMiniature)) {
    ...
    public NMSEntityBase getNMSEntityBase(final Entity entity) {
        final net.minecraft.server.v1_8_R2.Entity handle = ((CraftEntity)entity).getHandle();
    ...
    public static boolean addEntityToWorld(final WorldServer obj, final net.minecraft.server.v1_8_R2.Entity entity) {
        if (!Bukkit.isPrimaryThread()) {
            throw new IllegalArgumentException("Async entity add");
        }
        Method declaredMethod = null;
        try {
            declaredMethod = net.minecraft.server.v1_8_R2.World.class.getDeclaredMethod("a", net.minecraft.server.v1_8_R2.Entity.class);
        ...
        if (declaredMethod == null) {
            return obj.addEntity(entity, CreatureSpawnEvent.SpawnReason.CUSTOM);
        }
