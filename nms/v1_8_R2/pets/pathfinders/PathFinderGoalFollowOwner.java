...
package ws.billy.CookieGadgets.nms.v1_8_R2.pets.pathfinders;
    ...
    public void c() {
        if (this.pManager.getEquippedPet() != null) {
            ...
            if (distance > this.movingDistance) {
                ...
                entityPet.getAttributeInstance(GenericAttributes.d).setValue(this.speed);
            }
            else {
                entityPet.getAttributeInstance(GenericAttributes.d).setValue(0.0);
            }
        }
    }
}
