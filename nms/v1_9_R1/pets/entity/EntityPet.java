...
package ws.billy.CookieGadgets.nms.v1_9_R1.pets.entity;

import net.minecraft.server.v1_9_R1.NBTTagCompound;
import net.minecraft.server.v1_9_R1.DamageSource;
import ws.billy.CookieGadgets.nms.v1_9_R1.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public EntityPet(final World world, final IPet pet) {
        ...
        if (this.JUMP_FIELD == null) {
            try {
                (this.JUMP_FIELD = EntityLiving.class.getDeclaredField("bc")).setAccessible(true);
            }
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_9_R1.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_9_R1.Entity> iterator = this.passengers.iterator();
    ...
    public void g(float n, float be) {
        ...
        be = handle.be;
        if (be <= 0.0f) {
            be *= (float)(0.25 * this.rideSpeed);
        }
        else {
            be *= (float)this.rideSpeed;
        }
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_9_R1.Entity)this));
                if (be > 0.0f) {
        ...
        if (this.JUMP_FIELD != null) {
            if (!this.isOnGround((net.minecraft.server.v1_9_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_9_R1.Entity)this)) {
                try {
                    if (this.JUMP_FIELD.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_9_R1.Entity entity) {
    ...
    public boolean c(final int n, final net.minecraft.server.v1_9_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_9_R1.ItemStack itemStack) {
    }
