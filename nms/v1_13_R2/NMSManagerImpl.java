...
import ws.billy.CookieGadgets.nms.v1_13_R2.armorstand.NMSMiniature;
...
import ws.billy.CookieGadgets.nms.v1_13_R2.armorstand.ArmorStandFollower;
...
import ws.billy.CookieGadgets.nms.v1_13_R2.armorstand.EntityNMSArmorStand;
...
import ws.billy.CookieGadgets.nms.v1_13_R2.pathfinders.PathFinderGoalPanic;
import net.minecraft.server.v1_13_R2.EntityCreature;
import org.bukkit.craftbukkit.v1_13_R2.entity.CraftEntity;
import net.minecraft.server.v1_13_R2.EntityInsentient;
import ws.billy.CookieGadgets.nms.v1_13_R2.pets.entity.SpawnUtil;
import ws.billy.CookieGadgets.nms.v1_13_R2.pets.pathfinders.Pathfinders;
...
public class NMSManagerImpl implements NMSManager
{
    ...
    public NMSArmorStand spawnNMSArmorStand(final World world, final double n, final double n2, final double n3, final String s) {
        ...
        final EntityNMSArmorStand nmsNameable = new EntityNMSArmorStand((net.minecraft.server.v1_13_R2.World)handle, craftHologram);
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_13_R2.Entity)nmsNameable)) {
    ...
    public NMSArmorStand spawnNMSArmorStandFollower(final World world, final double n, final double n2, final double n3, final Player player, final double additionY, final String s, final ArmorStandSlot armorStandSlot, final ItemStack itemStack) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final ArmorStandFollower armorStandFollower = new ArmorStandFollower((net.minecraft.server.v1_13_R2.World)handle, player);
        armorStandFollower.setLocationNMS(n, n2, n3);
        armorStandFollower.setAdditionY(additionY);
        if (armorStandSlot != null && itemStack != null) {
            armorStandFollower.setSlotNMS(armorStandSlot.to_1_13_R2_Format(), CraftItemStack.asNMSCopy(itemStack));
        }
        if (s != null && !s.isEmpty()) {
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_13_R2.Entity)armorStandFollower)) {
    ...
    public NMSEntityMiniature spawnNMSMiniature(final World world, final double n, final double n2, final double n3, final boolean b, final Player player, final String s, final MiniatureEquipments miniatureEquipments) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final NMSMiniature nmsMiniature = new NMSMiniature((net.minecraft.server.v1_13_R2.World)handle, player, b);
        nmsMiniature.setLocationNMS(n, n2, n3);
        if (miniatureEquipments != null) {
            if (miniatureEquipments.getHand() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getHand().getMiniatureEquipments().getArmorStandSlot().to_1_13_R2_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getHand().getItemStack()));
            }
            if (miniatureEquipments.getHelmet() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getHelmet().getMiniatureEquipments().getArmorStandSlot().to_1_13_R2_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getHelmet().getItemStack()));
            }
            if (miniatureEquipments.getChestplate() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getChestplate().getMiniatureEquipments().getArmorStandSlot().to_1_13_R2_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getChestplate().getItemStack()));
            }
            if (miniatureEquipments.getLeggings() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getLeggings().getMiniatureEquipments().getArmorStandSlot().to_1_13_R2_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getLeggings().getItemStack()));
            }
            if (miniatureEquipments.getBoots() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getBoots().getMiniatureEquipments().getArmorStandSlot().to_1_13_R2_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getBoots().getItemStack()));
            }
        }
        if (s != null && !s.isEmpty()) {
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_13_R2.Entity)nmsMiniature)) {
    ...
    public NMSEntityBase getNMSEntityBase(final Entity entity) {
        final net.minecraft.server.v1_13_R2.Entity handle = ((CraftEntity)entity).getHandle();
    ...
    public static boolean addEntityToWorld(final WorldServer obj, final net.minecraft.server.v1_13_R2.Entity entity) {
        ...
        if (!obj.isChunkLoaded(floor, floor2, true)) {
            entity.dead = true;
            return false;
        }
        ...
        Label_0120: {
            if (VersionManager.isPaperServer()) {
                try {
                    ((List)ReflectionUtils.getField(net.minecraft.server.v1_13_R2.World.class, true, "entityList").get(obj)).add(entity);
                    break Label_0120;
                }
                catch (Exception ex) {
                    ex.printStackTrace();
            ...
            try {
                ReflectionUtils.invokeMethod(obj, net.minecraft.server.v1_13_R2.World.class, "b", entity);
            }
            catch (Exception ex2) {
                ex2.printStackTrace();
                return false;
