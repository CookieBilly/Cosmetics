...
public abstract class EntitySkeletonAbstractPet extends EntityPet
{
    ...
    public EntitySkeletonAbstractPet(final EntityTypes<?> entityTypes, final World world) {
        super(entityTypes, world);
    }
    
    public EntitySkeletonAbstractPet(final EntityTypes<?> entityTypes, final World world, final IPet pet) {
