...
import ws.billy.CookieGadgets.nms.v1_13_R2.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_13_R2.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_13_R2.Entity> iterator = this.passengers.iterator();
    ...
    public void a(float n, float bi, float bj) {
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_13_R2.Entity)this));
                if (bj > 0.0f) {
                ...
                this.aG += (n4 - this.aG) * 0.4f;
                this.aH += (int)this.aG;
            }
        }
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_13_R2.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_13_R2.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_13_R2.Entity entity) {
    ...
    public boolean c(final int n, final net.minecraft.server.v1_13_R2.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_13_R2.ItemStack itemStack) {
    }
