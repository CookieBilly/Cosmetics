...
package ws.billy.CookieGadgets.nms.v1_10_R1.pets.registry;

import net.minecraft.server.v1_10_R1.EntityZombie;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityZombiePet;
import net.minecraft.server.v1_10_R1.EntityWolf;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityWolfPet;
import net.minecraft.server.v1_10_R1.EntityWitch;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityWitchPet;
import net.minecraft.server.v1_10_R1.EntityWither;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityWitherPet;
import net.minecraft.server.v1_10_R1.EntityVillager;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityVillagerPet;
import net.minecraft.server.v1_10_R1.EntitySquid;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySquidPet;
import net.minecraft.server.v1_10_R1.EntitySpider;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySpiderPet;
import net.minecraft.server.v1_10_R1.EntitySnowman;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySnowmanPet;
import net.minecraft.server.v1_10_R1.EntitySkeleton;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySkeletonPet;
import net.minecraft.server.v1_10_R1.EntitySlime;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySlimePet;
import net.minecraft.server.v1_10_R1.EntitySilverfish;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySilverfishPet;
import net.minecraft.server.v1_10_R1.EntitySheep;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntitySheepPet;
import net.minecraft.server.v1_10_R1.EntityRabbit;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityRabbitPet;
import net.minecraft.server.v1_10_R1.EntityPolarBear;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityPolarBearPet;
import net.minecraft.server.v1_10_R1.EntityPigZombie;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityPigmanPet;
import net.minecraft.server.v1_10_R1.EntityPig;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityPigPet;
import net.minecraft.server.v1_10_R1.EntityOcelot;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityOcelotPet;
import net.minecraft.server.v1_10_R1.EntityMushroomCow;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityMushroomCowPet;
import net.minecraft.server.v1_10_R1.EntityMagmaCube;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityMagmaCubePet;
import net.minecraft.server.v1_10_R1.EntityIronGolem;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityIronGolemPet;
import net.minecraft.server.v1_10_R1.EntityHorse;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityHorsePet;
import net.minecraft.server.v1_10_R1.EntityEndermite;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityEndermitePet;
import net.minecraft.server.v1_10_R1.EntityEnderman;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityEndermanPet;
import net.minecraft.server.v1_10_R1.EntityCreeper;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityCreeperPet;
import net.minecraft.server.v1_10_R1.EntityCow;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityCowPet;
import net.minecraft.server.v1_10_R1.EntityChicken;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityChickenPet;
import net.minecraft.server.v1_10_R1.EntityCaveSpider;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityCaveSpiderPet;
import net.minecraft.server.v1_10_R1.EntityBat;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityBatPet;
import net.minecraft.server.v1_10_R1.EntityBlaze;
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.entity.types.EntityBlazePet;
...
public class PetRegistry
{
    ...
    public enum List
    {
        ...
        POLAR_BEAR(GEntity.POLAR_BEAR, (Class<? extends EntityPet>)EntityPolarBearPet.class, (Class<?>)EntityPolarBear.class), 
