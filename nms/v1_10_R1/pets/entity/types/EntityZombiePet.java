...
public class EntityZombiePet extends EntityAgeablePet implements IEntityZombiePet
{
    ...
    public GProfession getProfession() {
        return GProfession.getById((int)this.datawatcher.get((DataWatcherObject)EntityZombiePet.VILLAGER_TYPE));
    }
    
    @Override
    public void setProfession(final GProfession gProfession) {
        this.datawatcher.set((DataWatcherObject)EntityZombiePet.VILLAGER_TYPE, (Object)gProfession.getId());
    }
