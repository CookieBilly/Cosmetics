...
import ws.billy.CookieGadgets.nms.v1_10_R1.pets.CraftNMSCreature;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet, NMSPet
{
    ...
    public EntityPet(final World world, final IPet pet) {
        ...
        if (this.FIELD_JUMP == null) {
            try {
                (this.FIELD_JUMP = EntityLiving.class.getDeclaredField("be")).setAccessible(true);
            }
    ...
    public void setAsHatNMS() {
        ...
        craftPlayer.getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutMount((net.minecraft.server.v1_10_R1.Entity)craftPlayer.getHandle()));
    }
    ...
    protected boolean isOwnerRiding() {
        ...
        final Iterator<net.minecraft.server.v1_10_R1.Entity> iterator = this.passengers.iterator();
    ...
    public void g(float n, float bg) {
        if (this.pet == null) {
            return;
        }
        ...
        if (!this.world.isClientSide) {
            ...
            if (this instanceof IEntityHorsePet) {
                ...
                handle.playerConnection.sendPacket((Packet)new PacketPlayOutEntityTeleport((net.minecraft.server.v1_10_R1.Entity)this));
                if (bg > 0.0f) {
        ...
        if (this.FIELD_JUMP != null) {
            if (!this.isOnGround((net.minecraft.server.v1_10_R1.Entity)this) && this.pet.getType().getEntityPet().canFly()) {
                try {
            ...
            else if (this.isOnGround((net.minecraft.server.v1_10_R1.Entity)this)) {
                try {
                    if (this.FIELD_JUMP.getBoolean(handle)) {
                        this.motY = 0.3;
                    }
    ...
    protected boolean isOnGround(final net.minecraft.server.v1_10_R1.Entity entity) {
    ...
    public boolean c(final int n, final net.minecraft.server.v1_10_R1.ItemStack itemStack) {
        return false;
    }
    
    public void setSlot(final EnumItemSlot enumItemSlot, final net.minecraft.server.v1_10_R1.ItemStack itemStack) {
    }
