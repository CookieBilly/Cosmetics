...
package ws.billy.CookieGadgets.nms.v1_12_R1;
...
import ws.billy.CookieGadgets.nms.v1_12_R1.armorstand.NMSMiniature;
...
import ws.billy.CookieGadgets.nms.v1_12_R1.armorstand.ArmorStandFollower;
...
import ws.billy.CookieGadgets.nms.v1_12_R1.armorstand.EntityNMSArmorStand;
...
import ws.billy.CookieGadgets.nms.v1_12_R1.pathfinders.PathFinderGoalPanic;
import net.minecraft.server.v1_12_R1.EntityCreature;
import org.bukkit.craftbukkit.v1_12_R1.entity.CraftEntity;
import net.minecraft.server.v1_12_R1.EntityInsentient;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.SpawnUtil;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.registry.PetRegistry;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.pathfinders.Pathfinders;
...
public class NMSManagerImpl implements NMSManager
{
    ...
    public void registerPets() {
        PetRegistry[] values;
        for (int length = (values = PetRegistry.values()).length, i = 0; i < length; ++i) {
            values[i].registerPet();
        }
    }
    ...
    public NMSArmorStand spawnNMSArmorStand(final World world, final double n, final double n2, final double n3, final String s) {
        ...
        final EntityNMSArmorStand nmsNameable = new EntityNMSArmorStand((net.minecraft.server.v1_12_R1.World)handle, craftHologram);
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_12_R1.Entity)nmsNameable)) {
    ...
    public NMSArmorStand spawnNMSArmorStandFollower(final World world, final double n, final double n2, final double n3, final Player player, final double additionY, final String s, final ArmorStandSlot armorStandSlot, final ItemStack itemStack) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final ArmorStandFollower armorStandFollower = new ArmorStandFollower((net.minecraft.server.v1_12_R1.World)handle, player);
        armorStandFollower.setLocationNMS(n, n2, n3);
        armorStandFollower.setAdditionY(additionY);
        if (armorStandSlot != null && itemStack != null) {
            armorStandFollower.setSlotNMS(armorStandSlot.to_1_12_R1_Format(), CraftItemStack.asNMSCopy(itemStack));
        }
        if (s != null && !s.isEmpty()) {
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_12_R1.Entity)armorStandFollower)) {
    ...
    public NMSEntityMiniature spawnNMSMiniature(final World world, final double n, final double n2, final double n3, final boolean b, final Player player, final String s, final MiniatureEquipments miniatureEquipments) {
        final WorldServer handle = ((CraftWorld)world).getHandle();
        final NMSMiniature nmsMiniature = new NMSMiniature((net.minecraft.server.v1_12_R1.World)handle, player, b);
        nmsMiniature.setLocationNMS(n, n2, n3);
        if (miniatureEquipments != null) {
            if (miniatureEquipments.getHand() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getHand().getMiniatureEquipments().getArmorStandSlot().to_1_12_R1_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getHand().getItemStack()));
            }
            if (miniatureEquipments.getHelmet() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getHelmet().getMiniatureEquipments().getArmorStandSlot().to_1_12_R1_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getHelmet().getItemStack()));
            }
            if (miniatureEquipments.getChestplate() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getChestplate().getMiniatureEquipments().getArmorStandSlot().to_1_12_R1_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getChestplate().getItemStack()));
            }
            if (miniatureEquipments.getLeggings() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getLeggings().getMiniatureEquipments().getArmorStandSlot().to_1_12_R1_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getLeggings().getItemStack()));
            }
            if (miniatureEquipments.getBoots() != null) {
                nmsMiniature.setSlotNMS(miniatureEquipments.getBoots().getMiniatureEquipments().getArmorStandSlot().to_1_12_R1_Format(), CraftItemStack.asNMSCopy(miniatureEquipments.getBoots().getItemStack()));
            }
        }
        if (s != null && !s.isEmpty()) {
        ...
        if (!addEntityToWorld(handle, (net.minecraft.server.v1_12_R1.Entity)nmsMiniature)) {
    ...
    public NMSEntityBase getNMSEntityBase(final Entity entity) {
        final net.minecraft.server.v1_12_R1.Entity handle = ((CraftEntity)entity).getHandle();
    ...
    public static boolean addEntityToWorld(final WorldServer worldServer, final net.minecraft.server.v1_12_R1.Entity entity) {
        ...
        try {
            ReflectionUtils.invokeMethod(worldServer, net.minecraft.server.v1_12_R1.World.class, "b", entity);
        }
        catch (Exception ex) {
            ex.printStackTrace();
            return false;
