...
package ws.billy.CookieGadgets.nms.v1_12_R1.pets.registry;

import net.minecraft.server.v1_12_R1.Entity;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityZombieVillagerPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityZombieHorsePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityZombiePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityWolfPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityWitherSkeletonPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityWitherPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityWitchPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityVindicatorPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityVillagerPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityVexPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityStrayPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySquidPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySpiderPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySnowmanPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySlimePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySkeletonHorsePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySkeletonPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySilverfishPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntitySheepPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityRabbitPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityPolarBearPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityPigmanPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityPigPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityOcelotPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityMushroomCowPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityMulePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityMagmaCubePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityLlamaPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityIronGolemPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityIllusionerPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityHuskPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityHorsePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityEvokerPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityEndermitePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityEndermanPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityDonkeyPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityCreeperPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityCowPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityChickenPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityCaveSpiderPet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityBlazePet;
import ws.billy.CookieGadgets.nms.v1_12_R1.pets.entity.types.EntityBatPet;
...
public enum PetRegistry
{
    ...
    ILLUSIONER(NMSUtils.Type.ILLUSIONER, GEntity.ILLUSIONER, (Class<? extends EntityLiving>)EntityIllusionerPet.class), 
