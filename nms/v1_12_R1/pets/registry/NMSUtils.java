...
public class NMSUtils
{
    ...
    static {
        ...
        try {
            declaredField = clazz.getDeclaredField("t");
            declaredField2 = clazz.getDeclaredField("u");
            declaredField3 = clazz.getDeclaredField("v");
            declaredField4 = clazz.getDeclaredField("w");
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        final Iterator iterator = BiomeBase.i.iterator();
        int n = 0;
    ...
    public enum Type
    {
        ...
        ILLUSIONER(37, "illusion_illager", (Class<? extends Entity>)EntityIllagerIllusioner.class, MobMeta.MONSTER, false), 
