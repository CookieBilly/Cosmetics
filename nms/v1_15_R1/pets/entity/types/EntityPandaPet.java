...
public class EntityPandaPet extends EntityAgeablePet implements IEntityPandaPet
{
    ...
    static {
        ASK_FOR_BAMBOO_TICKS = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.b);
        SNEEZE_PROGRESS = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.b);
        EATING_TICKS = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.b);
        MAIN_GENE = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.a);
        HIDDEN_GENE = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.a);
        PANDA_FLAGS = DataWatcher.a((Class)EntityPandaPet.class, DataWatcherRegistry.a);
    }
