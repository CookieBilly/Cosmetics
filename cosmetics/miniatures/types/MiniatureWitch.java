...
public class MiniatureWitch extends Miniature
{
    private int step;
    
    public MiniatureWitch(final UUID uuid) {
        super(uuid, MiniatureType.WITCH);
    }
    ...
    public void onUpdate() {
        if (super.getMiniature() != null) {
            ...
            ParticleEffect.SPELL_WITCH.display(locationNMS.add(vector).add(0.0, 1.6, 0.0), 0.0f, 1);
            this.step += 4;
        }
    }
}
