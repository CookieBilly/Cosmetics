...
public class MiniatureScarecrow extends Miniature
{
    private int step;
    
    public MiniatureScarecrow(final UUID uuid) {
        super(uuid, MiniatureType.SCARECROW);
    }
    ...
    public void onUpdate() {
        if (super.getMiniature() != null) {
            ...
            ParticleEffect.CRIT.display(locationNMS.add(vector).add(0.0, 1.6, 0.0), 0.0f, 1);
            this.step += 4;
        }
    }
}
