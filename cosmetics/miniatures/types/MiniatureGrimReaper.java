...
public class MiniatureGrimReaper extends Miniature
{
    private int step;
    
    public MiniatureGrimReaper(final UUID uuid) {
        super(uuid, MiniatureType.GRIM_REAPER);
    }
    ...
    public void onUpdate() {
        if (super.getMiniature() != null) {
            ...
            ParticleEffect.SMOKE_NORMAL.display(locationNMS.add(vector).add(0.0, 1.6, 0.0), 0.0f, 1);
            this.step += 4;
        }
    }
}
